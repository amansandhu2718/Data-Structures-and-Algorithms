public class Aman193 {
    public static void main(String[] args) {
        ...
        System.out.println("" + AreSimiliar(root1, root2));
    }
    ...
    public static boolean AreSimiliar(NodeT n1, NodeT n2) {
        if (n1.data != n2.data) {
            return false;
        }
        ...
        for (int i = 0; i < n1.children.length; i++) {
            ...
            NodeT c2 = n2.children[i];
            if (!AreSimiliar(c1, c2)) {
                return false;
            }
        }
        return true;
